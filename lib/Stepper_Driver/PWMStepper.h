...
#define X_AXIS_PIN_DEFAULT 26
#define Y_AXIS_PIN_DEFAULT 25
#define Z_AXIS_PIN_DEFAULT 17
#define X_AXIS_DIR_DEFAULT 16
#define Y_AXIS_DIR_DEFAULT 27
#define Z_AXIS_DIR_DEFAULT 14
