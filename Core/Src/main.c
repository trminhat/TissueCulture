...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(ENA_DRV_X_GPIO_Port, ENA_DRV_X_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DIR_X_GPIO_Port, DIR_X_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED_GRN_Pin | LED_ORG_Pin | LED_RED_Pin | LED_BLU_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : ENA_DRV_X_Pin DIR_X_Pin */
  GPIO_InitStruct.Pin = ENA_DRV_X_Pin | DIR_X_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_GRN_Pin LED_ORG_Pin LED_RED_Pin LED_BLU_Pin */
  GPIO_InitStruct.Pin = LED_GRN_Pin | LED_ORG_Pin | LED_RED_Pin | LED_BLU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
